...
var _user$project$Lexicon$wordDefinitionView = function (model) {
	var _p0 = model.currentWord;
	if (_p0.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('no data');
	} else {
		var _p1 = _p0._0;
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(_p1.word),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(_p1.definition),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Lexicon$wordListStatusView = function (model) {
	var _p2 = model.wordList;
	if (_p2.ctor === 'Nothing') {
		return _elm_lang$html$Html$text('no data');
	} else {
		return _elm_lang$html$Html$text('received');
	}
};
var _user$project$Lexicon$update = F2(
	function (msg, model) {
		var _p3 = msg;
		switch (_p3.ctor) {
			case 'WordListReceived':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							wordList: _elm_lang$core$Maybe$Just(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'WordDefinitionReceived':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							currentWord: _elm_lang$core$Maybe$Just(_p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'HandleWordListResponse':
				var _p4 = _p3._0;
				if (_p4.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								wordList: _elm_lang$core$Maybe$Just(
									A2(_elm_lang$core$Debug$log, 'wordlist:', _p4._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					...
					if (_p5.ctor === 'BadPayload') {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									errorMessage: _elm_lang$core$Maybe$Just(_p5._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									errorMessage: _elm_lang$core$Maybe$Just('something happened')
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					}
				...
				if (_p6.ctor === 'Ok') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								currentWord: _elm_lang$core$Maybe$Just(
									A2(_elm_lang$core$Debug$log, 'currentWord:', _p6._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					var _p7 = _p6._0;
					if (_p7.ctor === 'BadPayload') {
						return {
							ctor: '_Tuple2',
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{
									errorMessage: _elm_lang$core$Maybe$Just(_p7._0)
								}),
							_1: _elm_lang$core$Platform_Cmd$none
						};
					} else {
...
var _user$project$Lexicon$wordEncoder = function (word) {
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'id',
				_1: _elm_lang$core$Json_Encode$string(word.id)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'word',
					_1: _elm_lang$core$Json_Encode$string(word.word)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'definition',
						_1: _elm_lang$core$Json_Encode$string(word.definition)
					},
					_1: {
						ctor: '::',
						_0: {
							...
							_1: _elm_lang$core$Json_Encode$list(
								A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, word.seeAlso))
						},
						_1: {ctor: '[]'}
					}
				}
...
var _user$project$Lexicon$wordToJson = function (word) {
	return A2(
		_elm_lang$core$Json_Encode$encode,
		4,
		_user$project$Lexicon$wordEncoder(word));
};
var _user$project$Lexicon$initialModel = {wordList: _elm_lang$core$Maybe$Nothing, currentWord: _elm_lang$core$Maybe$Nothing, errorMessage: _elm_lang$core$Maybe$Nothing};
var _user$project$Lexicon$wordListReceived = _elm_lang$core$Native_Platform.incomingPort(
	'wordListReceived',
...
var _user$project$Lexicon$wordDefinitionReceived = _elm_lang$core$Native_Platform.incomingPort(
	'wordDefinitionReceived',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (id) {
			return A2(
					...
					return A2(
						...
						function (definition) {
							return A2(
								...
								function (seeAlso) {
									return _elm_lang$core$Json_Decode$succeed(
										{id: id, word: word, definition: definition, seeAlso: seeAlso});
								},
								A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string)));
var _user$project$Lexicon$getWordDefinition = _elm_lang$core$Native_Platform.outgoingPort(
	'getWordDefinition',
	function (v) {
		return v;
	});
var _user$project$Lexicon$loadWordDefinition = function (id) {
	return _user$project$Lexicon$getWordDefinition(id);
};
var _user$project$Lexicon$loadWordDefinitionByWord = F2(
	function (word, wordList) {
		...
		var found = _elm_lang$core$List$head(
			A2(
				_elm_lang$core$List$filter,
				function (i) {
					return _elm_lang$core$Native_Utils.eq(i.word, word);
				},
				list));
		var _p9 = found;
		if (_p9.ctor === 'Just') {
			return _user$project$Lexicon$loadWordDefinition(_p9._0.id);
		} else {
			return _elm_lang$core$Platform_Cmd$none;
		}
	});
var _user$project$Lexicon$getWordList = _elm_lang$core$Native_Platform.outgoingPort(
	'getWordList',
	function (v) {
		return null;
	});
var _user$project$Lexicon$loadWordList = _user$project$Lexicon$getWordList(
	{ctor: '_Tuple0'});
var _user$project$Lexicon$WordDefinition = F4(
	function (a, b, c, d) {
		return {id: a, word: b, definition: c, seeAlso: d};
	});
var _user$project$Lexicon$responseDecoderForWordDefinition = A4(
	...
	A3(
		...
		A3(
			...
			A3(
				...
				'lexicon_id',
				_elm_lang$core$Json_Decode$string,
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Lexicon$WordDefinition)))));
var _user$project$Lexicon$Word = F2(
	function (a, b) {
		return {id: a, word: b};
	});
var _user$project$Lexicon$wordDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'word',
	_elm_lang$core$Json_Decode$string,
	A3(
		...
		'lexicon_id',
		_elm_lang$core$Json_Decode$string,
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Lexicon$Word)));
var _user$project$Lexicon$responseDecoder = _elm_lang$core$Json_Decode$list(_user$project$Lexicon$wordDecoder);
var _user$project$Lexicon$Model = F3(
	function (a, b, c) {
		return {wordList: a, currentWord: b, errorMessage: c};
	});
var _user$project$Lexicon$WordDefinitionReceived = function (a) {
	return {ctor: 'WordDefinitionReceived', _0: a};
};
var _user$project$Lexicon$WordListReceived = function (a) {
	return {ctor: 'WordListReceived', _0: a};
};
var _user$project$Lexicon$subscriptions = _elm_lang$core$Platform_Sub$batch(
	{
		ctor: '::',
		_0: _user$project$Lexicon$wordListReceived(
			function (wl) {
				return _user$project$Lexicon$WordListReceived(wl);
			}),
		_1: {
			ctor: '::',
			_0: _user$project$Lexicon$wordDefinitionReceived(
				function (w) {
					return _user$project$Lexicon$WordDefinitionReceived(w);
				}),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Lexicon$HandleWordDefinitionResponse = function (a) {
	return {ctor: 'HandleWordDefinitionResponse', _0: a};
};
var _user$project$Lexicon$HandleWordListResponse = function (a) {
	return {ctor: 'HandleWordListResponse', _0: a};
};

var _user$project$Theme_Colors$theme = {
	palette: {
		white: A3(_rtfeldman$elm_css$Css$rgb, 255, 255, 255),
		green: A3(_rtfeldman$elm_css$Css$rgb, 122, 153, 27),
		lightGreen: A3(_rtfeldman$elm_css$Css$rgb, 171, 208, 57),
		darkGreen: _rtfeldman$elm_css$Css$hex('#03697d'),
		blue: A3(_rtfeldman$elm_css$Css$rgb, 46, 153, 174),
		darkBlue: A3(_rtfeldman$elm_css$Css$rgb, 10, 70, 80),
		cream: A3(_rtfeldman$elm_css$Css$rgb, 254, 248, 222),
		lightBlue: A3(_rtfeldman$elm_css$Css$rgb, 140, 230, 250)
	},
	button: {
		background: A3(_rtfeldman$elm_css$Css$rgb, 77, 136, 0),
		active: A3(_rtfeldman$elm_css$Css$rgb, 57, 101, 0),
		text: A3(_rtfeldman$elm_css$Css$rgb, 237, 237, 237)
	}
};
var _user$project$Theme_Colors$Palette = F8(
	function (a, b, c, d, e, f, g, h) {
		return {white: a, green: b, lightGreen: c, darkGreen: d, blue: e, darkBlue: f, cream: g, lightBlue: h};
	});
var _user$project$Theme_Colors$ButtonTheme = F3(
	function (a, b, c) {
		return {background: a, active: b, text: c};
	});
var _user$project$Theme_Colors$Theme = F2(
	function (a, b) {
		return {palette: a, button: b};
	});

var _user$project$Theme_Elements$takeFurther = A2(
		...
		_0: A2(
			_rtfeldman$elm_css$Html_Styled$span,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(_user$project$Theme_Colors$theme.palette.lightBlue),
						_1: {
							ctor: '::',
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('Go for a word adventure:'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Theme_Elements$seeAlso = F2(
	function (click, word) {
		return _elm_lang$core$Native_Utils.eq(
			...
			_rtfeldman$elm_css$Html_Styled$button,
			{
				...
				_1: {
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(click),
					_1: {ctor: '[]'}
				}
			},
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text(word),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Theme_Elements$fontAwesomeIcon = F2(
	function (name, size) {
		return A2(
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$classList(
					{
						...
						_0: {
							ctor: '_Tuple2',
							_0: A2(_elm_lang$core$Basics_ops['++'], 'fa-', name),
							_1: true
						},
						_1: {
							ctor: '::',
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: A2(_elm_lang$core$Basics_ops['++'], 'fa-', size),
									_1: true
								},
								_1: {ctor: '[]'}
							}
...
var _user$project$Theme_Elements$icon = F2(
	function (name, click) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
			...
			{
				ctor: '::',
				_0: A2(_user$project$Theme_Elements$fontAwesomeIcon, name, '2x'),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Theme_Elements$wordDefinitionIcon = F2(
	function (click, name) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$color(_user$project$Theme_Colors$theme.palette.lightGreen),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$padding(
								_rtfeldman$elm_css$Css$px(5)),
			...
			{
				ctor: '::',
				_0: A2(_user$project$Theme_Elements$fontAwesomeIcon, name, 'lg'),
				_1: {ctor: '[]'}
			});
	});
var _user$project$Theme_Elements$listHeader = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('Scroll the results and choose a word!'),
				_1: {ctor: '[]'}
			}),
		_1: {
			ctor: '::',
								...
								_1: {
									...
									_1: {
										...
										_0: A3(
											...
											_user$project$Theme_Colors$theme.palette.lightBlue),
										_1: {
											ctor: '::',
...
var _user$project$Theme_Elements$searchBox = F2(
	function (changed, query) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					_rtfeldman$elm_css$Html_Styled$input,
					{
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onInput(changed),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled_Attributes$value(query),
								_1: {ctor: '[]'}
							}
						}
					},
										...
										_1: {
											...
											_1: {
												...
												_0: A3(
													...
													_rtfeldman$elm_css$Css$solid,
													_user$project$Theme_Colors$theme.palette.white),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$width(
...
var _user$project$Theme_Elements$searchHeader = function (click) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('Enter a single word or part of a word'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Need help?'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Theme_Elements$headerTitle = A2(
	_rtfeldman$elm_css$Html_Styled$div,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
			{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Css$backgroundColor(
						_rtfeldman$elm_css$Css$hex('#0a4650')),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Css$height(
							_rtfeldman$elm_css$Css$px(43)),
						_1: {
							ctor: '::',
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _rtfeldman$elm_css$Html_Styled$text('A Hindu Lexicon'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _user$project$Theme_Elements$headerStyle = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
...
var _user$project$Theme_Elements$bodyStyle = _rtfeldman$elm_css$Css$batch(
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Theme_Colors$theme.palette.darkGreen),
		_1: {
			ctor: '::',
			_0: _rtfeldman$elm_css$Css$height(
				_rtfeldman$elm_css$Css$pct(100)),
...
var _user$project$Theme_Elements$toolbarButton = A2(
...
var _user$project$Theme_Elements$navButton = function (isCurrentPage) {
	var bgColor = isCurrentPage ? _user$project$Theme_Colors$theme.button.active : _user$project$Theme_Colors$theme.button.background;
	return A2(
		_rtfeldman$elm_css$Html_Styled$styled,
		_rtfeldman$elm_css$Html_Styled$button,
		{
			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$backgroundColor(bgColor),
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$borderStyle(_rtfeldman$elm_css$Css$none),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$color(_user$project$Theme_Colors$theme.button.text),
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$hover(
											{
												ctor: '::',
												_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Theme_Colors$theme.button.active),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$Main$helpView = function (karma) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Welcome the Hindu Lexicon! Type the characters that you know are in a word. All the possible choices will appear. Use less characters if you do not know to the spelling of a word. Use more if want to limit the choices.'),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text(' Gurudeva recommended study of one word and associated words. Take:'),
							_1: {
								ctor: '::',
								_0: A2(
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: A2(_user$project$Theme_Elements$seeAlso, karma, 'karma'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Html_Styled$text(' and go a word adventure clicking the other that pop up. You can a word to my word, but click the bookmark. When you are in My Word, clicking the bookmark will delete word. '),
											_1: {ctor: '[]'}
										}
									}
								}
...
var _user$project$Main$loadingView = A2(
	_rtfeldman$elm_css$Html_Styled$h1,
	{
		ctor: '::',
		_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
...
var _user$project$Main$isSeeAlsoEmpty = function (list) {
	var _p0 = list;
	if (_p0.ctor === '::') {
		return _elm_lang$core$Native_Utils.eq(
...
var _user$project$Main$filterWordList = F2(
	function (word, list) {
		return _elm_lang$core$String$isEmpty(word) ? list : A2(
			_elm_lang$core$List$filter,
			function (item) {
				return A2(
					_elm_lang$core$String$contains,
					_elm_lang$core$String$toLower(word),
					_elm_lang$core$String$toLower(item.word));
			},
			list);
	});
var _user$project$Main$isWordSaved = F2(
	function (word, wordList) {
		var list = A2(
			_elm_lang$core$List$filter,
			function (item) {
				return _elm_lang$core$Native_Utils.eq(item.word, word);
			},
			wordList);
...
var _user$project$Main$savedWordListChanged = _elm_lang$core$Native_Platform.incomingPort(
	...
	_elm_lang$core$Json_Decode$list(
		A2(
			...
			A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string))));
var _user$project$Main$removeSavedWord = _elm_lang$core$Native_Platform.outgoingPort(
	'removeSavedWord',
	function (v) {
		return v;
	});
var _user$project$Main$appGoSettings = _elm_lang$core$Native_Platform.outgoingPort(
	'appGoSettings',
	function (v) {
		return null;
	});
var _user$project$Main$appGoHome = _elm_lang$core$Native_Platform.outgoingPort(
	'appGoHome',
	function (v) {
		return null;
	});
...
var _user$project$Main$HelpView = {ctor: 'HelpView'};
var _user$project$Main$DefinitionView = {ctor: 'DefinitionView'};
var _user$project$Main$MyWordsView = {ctor: 'MyWordsView'};
var _user$project$Main$SurpriseView = {ctor: 'SurpriseView'};
...
var _user$project$Main$appNavigation = A2(
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _rtfeldman$elm_css$Css$backgroundColor(_user$project$Theme_Colors$theme.palette.darkBlue),
										_1: {
											ctor: '::',
											_0: _rtfeldman$elm_css$Css$height(
	...
	{
		ctor: '::',
		_0: A2(_user$project$Theme_Elements$icon, 'home', _user$project$Main$GoHome),
		_1: {
			ctor: '::',
			_0: A2(_user$project$Theme_Elements$icon, 'cog', _user$project$Main$GoSettings),
			_1: {ctor: '[]'}
		}
	});
var _user$project$Main$SavedWordListChanged = function (a) {
	return {ctor: 'SavedWordListChanged', _0: a};
};
var _user$project$Main$RemoveSavedWord = function (a) {
	return {ctor: 'RemoveSavedWord', _0: a};
};
var _user$project$Main$SaveWord = function (a) {
	return {ctor: 'SaveWord', _0: a};
};
var _user$project$Main$bookmarkIconView = F2(
	function (definition, wordlist) {
		var list = function () {
			var _p1 = wordlist;
			if (_p1.ctor === 'Just') {
				return _p1._0;
		...
		var isSaved = A2(_user$project$Main$isWordSaved, definition.word, list);
		return isSaved ? A2(
			_user$project$Theme_Elements$wordDefinitionIcon,
			_user$project$Main$SaveWord(definition),
			'bookmark-o') : A2(
			_user$project$Theme_Elements$wordDefinitionIcon,
			_user$project$Main$RemoveSavedWord(definition),
			'bookmark');
	});
var _user$project$Main$FilterWordList = function (a) {
	return {ctor: 'FilterWordList', _0: a};
};
var _user$project$Main$LoadRandomDefinition = {ctor: 'LoadRandomDefinition'};
var _user$project$Main$LoadDefinitionByWord = function (a) {
	return {ctor: 'LoadDefinitionByWord', _0: a};
};
var _user$project$Main$definitionView = function (model) {
	var _p2 = model.lexiconModel.currentWord;
	if (_p2.ctor === 'Just') {
		var _p3 = _p2._0;
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text(_p3.word),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(
									...
									_1: {
										...
										_1: {
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css$color(_user$project$Theme_Colors$theme.palette.green),
													_1: {ctor: '[]'}
												}
											}
										}
						...
						{
							ctor: '::',
							_0: A2(_user$project$Main$bookmarkIconView, _p3, model.savedWords),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _rtfeldman$elm_css$Html_Styled$text(_p3.definition),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
							_0: _user$project$Main$isSeeAlsoEmpty(_p3.seeAlso) ? A2(
								_rtfeldman$elm_css$Html_Styled$div,
								{ctor: '[]'},
								{ctor: '[]'}) : A2(
								_rtfeldman$elm_css$Html_Styled$div,
								...
								{
									ctor: '::',
									_0: _user$project$Theme_Elements$takeFurther,
									_1: {
										ctor: '::',
										_0: A2(
											_rtfeldman$elm_css$Html_Styled$div,
											...
											A2(
												...
												function (i) {
													return A2(
														_user$project$Theme_Elements$seeAlso,
														_user$project$Main$LoadDefinitionByWord(i),
														i);
												},
												_p3.seeAlso)),
										_1: {ctor: '[]'}
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('wait...'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$LoadDefinitionByInt = function (a) {
	return {ctor: 'LoadDefinitionByInt', _0: a};
};
var _user$project$Main$LoadDefinition = function (a) {
	return {ctor: 'LoadDefinition', _0: a};
};
var _user$project$Main$addWordItem = function (word) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$li,
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
				_user$project$Main$LoadDefinition(word.id)),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _rtfeldman$elm_css$Html_Styled$text(word.word),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Main$pageNavigation = function (currentPage) {
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: A3(
				_user$project$Theme_Elements$navButton,
				_elm_lang$core$Native_Utils.eq(activePage, 'search'),
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
						_user$project$Main$Navigate(_user$project$Main$SearchView)),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _rtfeldman$elm_css$Html_Styled$text('Search'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(_user$project$Main$LoadRandomDefinition),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('Surprise!'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A3(
						_user$project$Theme_Elements$navButton,
						_elm_lang$core$Native_Utils.eq(activePage, 'mywords'),
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onClick(
								_user$project$Main$Navigate(_user$project$Main$MyWordsView)),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled$text('My Words'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _user$project$Main$searchView = function (model) {
	var _p5 = model.lexiconModel.wordList;
	if (_p5.ctor === 'Just') {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
			...
			{
				ctor: '::',
				_0: _user$project$Theme_Elements$searchHeader(
					_user$project$Main$Navigate(_user$project$Main$HelpView)),
				_1: {
					ctor: '::',
					_0: A2(_user$project$Theme_Elements$searchBox, _user$project$Main$FilterWordList, model.query),
					_1: {
						ctor: '::',
						_0: _user$project$Theme_Elements$listHeader,
						_1: {
							ctor: '::',
							_0: A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$Main$addWordItem,
									A2(_user$project$Main$filterWordList, model.query, _p5._0))),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Main$myWordsView = function (model) {
	var _p6 = model.savedWords;
	if (_p6.ctor === 'Just') {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
						...
						_1: {
							...
							_0: A2(
								...
								A2(
									_elm_lang$core$List$map,
									_user$project$Main$addWordItem,
									A2(_user$project$Main$filterWordList, model.query, _p6._0))),
							_1: {ctor: '[]'}
						}
					}
				}
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('You can click on the bookmark icon on word definitions to save them!'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
...
var _user$project$Main$view = function (model) {
	var activeView = function () {
		...
		switch (_p7.ctor) {
			case 'DefinitionView':
				return _user$project$Main$definitionView(model);
			case 'LoadingView':
				return _user$project$Main$loadingView;
			case 'SearchView':
				return _user$project$Main$searchView(model);
			case 'MyWordsView':
				return _user$project$Main$myWordsView(model);
			case 'HelpView':
				return _user$project$Main$helpView(
					_user$project$Main$LoadDefinitionByWord('karma'));
			default:
				return A2(
					_rtfeldman$elm_css$Html_Styled$h1,
					{ctor: '[]'},
					{
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled$text('not implemented'),
						_1: {ctor: '[]'}
					});
		}
	}();
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			...
			_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
				{
					ctor: '::',
					_0: _user$project$Theme_Elements$bodyStyle,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		},
			...
			_0: A2(
				_rtfeldman$elm_css$Html_Styled$div,
				{
					...
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
						{
							ctor: '::',
							_0: _user$project$Theme_Elements$headerStyle,
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _user$project$Theme_Elements$headerTitle,
					_1: {
						ctor: '::',
						_0: _user$project$Main$pageNavigation(model.currentPage),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _user$project$Main$appNavigation,
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$LexiconMsg = function (a) {
...
var _user$project$Main$subscriptions = function (model) {
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$Main$savedWordListChanged(
				function (wl) {
					return _user$project$Main$SavedWordListChanged(wl);
				}),
			_1: {
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Sub$map, _user$project$Main$LexiconMsg, _user$project$Lexicon$subscriptions),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$startApplication = A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$LexiconMsg, _user$project$Lexicon$loadWordList);
var _user$project$Main$init = function (wl) {
	return _elm_lang$core$List$isEmpty(wl) ? {ctor: '_Tuple2', _0: _user$project$Main$initialModel, _1: _user$project$Main$startApplication} : {
		ctor: '_Tuple2',
		_0: _elm_lang$core$Native_Utils.update(
			_user$project$Main$initialModel,
			{
				savedWords: _elm_lang$core$Maybe$Just(wl)
			}),
		_1: _user$project$Main$startApplication
	};
};
		...
		switch (_p8.ctor) {
			case 'GoHome':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$appGoHome(
						{ctor: '_Tuple0'})
				};
			case 'GoSettings':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$appGoSettings(
						{ctor: '_Tuple0'})
				};
			case 'LexiconMsg':
				var _p11 = _p8._0;
				var _p9 = A2(_user$project$Lexicon$update, _p11, model.lexiconModel);
				var updateLexiconModel = _p9._0;
				var lexiconCmd = _p9._1;
				var _p10 = _p11;
				switch (_p10.ctor) {
					case 'WordListReceived':
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{currentPage: _user$project$Main$SearchView, lexiconModel: updateLexiconModel}),
					...
					default:
						return {
							...
							_0: _elm_lang$core$Native_Utils.update(
								model,
								{lexiconModel: updateLexiconModel}),
							_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$LexiconMsg, lexiconCmd)
						};
				}
			case 'Navigate':
			...
			case 'LoadRandomDefinition':
				var _p12 = model.lexiconModel.wordList;
				if (_p12.ctor === 'Just') {
					var lastItem = _elm_lang$core$List$length(_p12._0) - 1;
					var gen = A2(_elm_lang$core$Random$int, 1, lastItem);
					return {
						ctor: '_Tuple2',
						_0: model,
						_1: A2(_elm_lang$core$Random$generate, _user$project$Main$LoadDefinitionByInt, gen)
					};
				} else {
			...
			case 'LoadDefinition':
				return {
					...
					_1: A2(
						...
						_user$project$Main$LexiconMsg,
						_user$project$Lexicon$loadWordDefinition(_p8._0))
				};
			case 'LoadDefinitionByWord':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$Main$LexiconMsg,
						A2(_user$project$Lexicon$loadWordDefinitionByWord, _p8._0, model.lexiconModel.wordList))
				};
			case 'LoadDefinitionByInt':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_user$project$Main$LexiconMsg,
						_user$project$Lexicon$loadWordDefinition(
			...
			case 'SaveWord':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$saveWord(
						_user$project$Lexicon$wordEncoder(_p8._0))
				};
			case 'RemoveSavedWord':
				return {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'SavedWordListChanged':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							savedWords: _elm_lang$core$Maybe$Just(_p8._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
